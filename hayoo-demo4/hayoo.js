...
function handle_expand_collapse(me) {
  console.log("in handle_expand_collapse", "me:", me)

  var div = me.parentNode.nextSibling
  console.log("div = ", div, "this:", this)
...
function makeMores (target) {
    ...
    $(t).find('.more').each(function() {
        ...
        $(this).children().each(function(i,e) {
          if (i > 0) { $(e).toggle(); add_div = true; }
        })

        if (add_div) {
          var div = document.createElement("div")
          div.innerHTML = '<p class="expander" onclick="handle_expand_collapse(this)">&nbsp;'
