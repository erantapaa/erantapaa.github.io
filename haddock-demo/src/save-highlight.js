...
function process_comment_block(elt) {
  // elt.previousSibling should be an starting line <a> tag.
...
function find_line_widths() {
  // determine all line widths
...
function best_position(px, yline, width, hlines) {
  // return the best position for a box of a certain width (in pixels)
  // and height (in lines) which is closest to (x,y)
